...
Para mais detalhes, entre em contato conosco!`;
  ...
  return httpServer;
}The changes aim to correct the budget item creation process by ensuring that after the budget is created, its items are processed only once, preventing duplicates.
