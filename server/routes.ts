...
This commit refines the client name resolution logic in the budgets endpoint by prioritizing `contactName` and providing a fallback to client records when `contactName` is absent.
<replit_final_file>
import type { Express } from "express";
import { createServer, type Server } from "http";
import multer from 'multer';
