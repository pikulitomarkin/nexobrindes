...
export default function LogisticsProducts() {
  ...
  const [productForm, setProductForm] = useState({
    ...
    mainColor: "",
    secondaryColor: "",
    producerId: "internal", // Padrão para produtos internos
    type: "internal" // "internal" ou "external"
  });
      ...
      <Card className="shadow-xl border-0">
        <CardHeader className="bg-gradient-to-r from-orange-600 to-red-600 text-white rounded-t-lg">
          <div className="flex justify-between items-center">
            <CardTitle className="text-xl font-semibold">Catálogo de Produtos - Logística</CardTitle>
            <div className="flex gap-2">
              ...
              <Dialog open={isProductDialogOpen} onOpenChange={(open) => {
                ...
                <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                  <DialogHeader>
                    <DialogTitle>
                      {editingProduct ? "Editar Produto" : "Novo Produto Interno"}
                    </DialogTitle>
                    <DialogDescription>
                      {editingProduct ? "Edite as informações do produto" : "Cadastre um novo produto interno da empresa"}
                    </DialogDescription>
                  </DialogHeader>
