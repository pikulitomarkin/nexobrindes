                  ...
                  return (
                    <tr key={order.id} className={isOrderOverdue ? "bg-red-50" : ""}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        <div className="text-xs text-gray-500">Cliente: {order.orderNumber}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-xs text-gray-600">
                          <div className="truncate max-w-32" title="Ver endereço completo nos detalhes">
                            📍 {order.clientAddress ? 'Endereço cadastrado' : 'Sem endereço'}
                          </div>
                        </div>
                      </td>
