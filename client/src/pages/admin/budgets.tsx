...
import { Plus, FileText, Send, Eye, Search, ShoppingCart, Calculator, Package, Percent, Trash2, Edit, Factory, Bell, X, AlertTriangle, Upload } from "lucide-react";
  ...
  const updateAdminBudgetItem = (index: number, field: string, value: any) => {
    setAdminBudgetForm(prev => {
      ...
      if (field === 'quantity') {
        ...
        item.totalPrice = calculateAdminItemTotal(item);
      } else {
        item[field] = value;
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 mb-4">
                          ...
                          <div>
                            ...
                            <Input
                              ...
                              key={`admin-unit-price-${index}-${item.unitPrice}`}
                              onChange={(e) => {
                              ...
                              onBlur={(e) => {
                                ...
                                updateAdminBudgetItem(index, 'unitPrice', parseCurrencyValue(e.target.value));
                              }}
                              className="h-10"
                            />
                            {(() => {
