  ...
  return (
    <div className="p-8">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Gerenciar Vendedores - Sócio</h1>
          <p className="text-gray-600">Cadastre e gerencie vendedores do sistema como sócio</p>
        </div>
