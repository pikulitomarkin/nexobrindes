...
export default function VendorLogs() {
  ...
  // Buscar logs específicos do vendedor
  const { data: logs = [], isLoading, refetch } = useQuery({
    queryKey: ["/api/vendor/logs", vendorId, { search: searchTerm, action: actionFilter, level: levelFilter, date: dateFilter }],
    queryFn: async () => {
  ...
  // Buscar clientes do vendedor para contexto
  const { data: vendorClients = [] } = useQuery({
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Meus Logs do Sistema</h1>
          <p className="text-gray-600">Histórico das suas ações e dos seus clientes</p>
          <p className="text-sm text-blue-600 mt-1">
            Vendedor: <strong>{user.name}</strong>
          </p>
        </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold gradient-text">{vendorClients.length}</p>
              </div>
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <span className="text-sm text-gray-600">
                            por <strong>{log.userName || user.name}</strong>
                          </span>
